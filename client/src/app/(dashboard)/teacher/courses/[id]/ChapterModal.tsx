    ...
    <CustomModal isOpen={isChapterModalOpen} onClose={onClose}>
      <div className="chapter-modal">
        <div className="chapter-modal__header">
          <h2 className="chapter-modal__title">Adicionar | Editar Aula</h2>
        ...
        <Form {...methods}>
          ...
          >
            <CustomFormField
              ...
              placeholder="Escreva aqui o titulo da sua aula"
            />

            <CustomFormField
              name="content"
              label="Conteudo da aula"
              type="textarea"
              placeholder="Escreva aqui os conteúdos referentes a aula"
            />
                    ...
                    <div>
                      ...
                      {typeof value === "string" && value && (
                        <div className="my-2 text-sm text-gray-600">
                          Aula selecionada: {value.split("/").pop()}
                        </div>
                      )}
                      {value instanceof File && (
                        <div className="my-2 text-sm text-gray-600">
                          Selecionar arquivo: {value.name}
                        </div>
                      )}
                    </div>
                  </FormControl>
